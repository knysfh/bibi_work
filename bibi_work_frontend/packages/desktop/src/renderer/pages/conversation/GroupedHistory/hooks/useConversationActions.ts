...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via BiWorkModal in the GroupedHistory component.
   * Uses project's design system: BiWorkModal component with danger-styled action button.
   */
