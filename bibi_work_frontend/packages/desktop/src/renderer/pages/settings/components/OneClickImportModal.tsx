...
import BiWorkSteps from '@/renderer/components/base/BiWorkSteps';
  ...
  return (
    ...
    >
      <div className='flex h-full min-h-0 flex-col pt-20px'>
        ...
        <div className='mb-6'>
          <BiWorkSteps current={currentStep} size='small'>
            <BiWorkSteps.Step
            ...
            />
            <BiWorkSteps.Step title={t('settings.mcpStepImportSuccess')} />
          </BiWorkSteps>
        </div>
