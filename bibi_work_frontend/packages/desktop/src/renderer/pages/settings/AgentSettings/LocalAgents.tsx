...
const LOCAL_AGENT_SETUP_GUIDE_URL = 'https://github.com/knysfh/bibi_work/wiki/ACP-Setup';
...
const LocalAgents: React.FC = () => {
  ...
  const sortedOfficialAgents = [...officialAgents].toSorted((left, right) => left.name.localeCompare(right.name));
  ...
  return (
    <div data-testid='agent-management-page' className='flex flex-col gap-16px py-16px px-16px'>
      <SettingsPageHeader
        ...
        actions={
          <div className='flex items-center gap-8px'>
            <Button data-testid='btn-open-agent-hub' onClick={() => setHubVisible(true)}>
      ...
      <AgentHubModal visible={hubVisible} onCancel={() => setHubVisible(false)} />
