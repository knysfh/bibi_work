...
import { useWorkbenchFeatureFlag } from '@/renderer/hooks/workbench/useWorkbenchFeatureFlags';
...
const DevSettings: React.FC = () => {
  ...
  const { enabled: cdpRemoteControlEnabled } = useWorkbenchFeatureFlag('desktop.cdp_remote_control', false);
