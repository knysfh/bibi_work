                ...
                {imageGenerationModelList.length > 0 ? (
                  ...
                  >
                    {imageGenerationModelList.map(({ models, ...platform }) => (
                      <BiWorkSelect.OptGroup label={platform.name} key={platform.id}>
                        {models.map((modelName) => (
                          <BiWorkSelect.Option key={platform.id + modelName} value={platform.id + '|' + modelName}>
                            {modelName}
                          </BiWorkSelect.Option>
                        ))}
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/knysfh/bibi_work/wiki/BiWork-Image-Generation-Tool-Model-Configuration-Guide'
                            target='_blank'
