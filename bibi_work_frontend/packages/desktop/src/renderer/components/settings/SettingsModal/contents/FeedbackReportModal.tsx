...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({
  ...
  // "Solve via chat": hand the report to the BiWork Butler for on-the-spot
  ...
  return (
    <ModalWrapper
      ...
      // BiWorkModal (e.g. the Agent editor). Arco's default z-index stacks
