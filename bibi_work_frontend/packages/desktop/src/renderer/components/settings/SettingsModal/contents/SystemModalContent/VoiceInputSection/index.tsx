        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <BiWorkSelect value={source} onChange={handleSourceChange}>
                <BiWorkSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</BiWorkSelect.Option>
                <BiWorkSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</BiWorkSelect.Option>
                <BiWorkSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</BiWorkSelect.Option>
              </BiWorkSelect>
            </Form.Item>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <BiWorkSelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <BiWorkSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <BiWorkSelect.Option key={option.value || 'auto'} value={option.value}>
