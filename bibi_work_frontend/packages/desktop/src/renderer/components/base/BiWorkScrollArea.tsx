 ...
 * <BiWorkScrollArea className="h-400px">
 *   <div>Content...</div>
 * </BiWorkScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <BiWorkScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </BiWorkScrollArea>
 *
 * // 双向滚动 / Both directions
 * <BiWorkScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </BiWorkScrollArea>
 * ```
 */
interface BiWorkScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const BiWorkScrollArea: React.FC<BiWorkScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
BiWorkScrollArea.displayName = 'BiWorkScrollArea';

export default BiWorkScrollArea;
