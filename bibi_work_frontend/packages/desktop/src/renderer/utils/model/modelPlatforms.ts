...
const buildLogoAssetUrl = (_path: string): null => {
  // Legacy /api/assets/logos/* files are not bundled in this fork. Return null
  // so provider dropdowns render their built-in fallback instead of 404 images.
  return null;
};
