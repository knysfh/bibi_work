export const WORKSPACE_TOGGLE_EVENT = 'biwork-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'biwork-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'biwork-workspace-has-files';
