 ...
 *   - macOS:   ~/Library/Logs/BiWork/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\BiWork\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/BiWork/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
...
const BACKEND_PREFIX = '[BiWork backend]';
