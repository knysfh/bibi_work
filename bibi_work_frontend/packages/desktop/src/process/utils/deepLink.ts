...
export const PROTOCOL_SCHEME = 'biwork';

/**
 * Parse an biwork:// URL into action and params.
 * Supports two formats:
 *   1. biwork://add-provider?base_url=xxx&api_key=xxx
 *   2. biwork://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
