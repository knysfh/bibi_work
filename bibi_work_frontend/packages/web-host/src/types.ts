// Core types for @biwork/web-host (M3 interface contract, locked for M4-M8)
...
/**
 * System dirs exported to the backend via BIWORK_{CACHE,WORK,LOG}_DIR env.
...
export type WebHostOptions = {
  ...
  backend: { kind: 'useExistingBackend'; port: number };
};
