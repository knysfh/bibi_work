...
function getLogFilePath(): string {
  ...
  // Dev mode uses "BiWork-Dev", production uses "BiWork"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'BiWork-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'BiWork', `${today}.log`);
