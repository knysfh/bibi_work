...
for f in BiWork-1.0.0-win-x64.exe BiWork-1.0.0-win-arm64.exe BiWork-1.0.0-mac-x64.dmg BiWork-1.0.0-mac-arm64.dmg BiWork-1.0.0.deb BiWork-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
