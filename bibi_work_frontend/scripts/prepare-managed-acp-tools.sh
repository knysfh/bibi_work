...
Environment variables:
  ...
  MANAGED_ACP_CDN_BASE         Optional. Public CDN base. Default: https://static.biwork.com/managed/acp
...
MANAGED_ACP_CDN_BASE="${MANAGED_ACP_CDN_BASE:-https://static.biwork.com/managed/acp}"
