...
describe('UpdateNotificationCard', () => {
  beforeEach(() => {
    ...
    mocks.updateCheckMock.mockResolvedValue({
      ...
      data: {
        ...
        latest: {
          ...
          name: 'v2.1.14',
          body: 'notes',
          htmlUrl: 'https://github.com/knysfh/bibi_work/releases/tag/v2.1.14',
          prerelease: false,
          draft: false,
          assets: [],
          recommendedAsset: {
            name: 'BiWork-2.1.14-mac-arm64.dmg',
            url: 'https://static.biwork.com/releases/2.1.14/BiWork-2.1.14-mac-arm64.dmg',
            fallbackUrl: 'https://github.com/knysfh/bibi_work/releases/download/v2.1.14/BiWork-2.1.14-mac-arm64.dmg',
            size: 123,
          },
        },
      },
    ...
    mocks.updateDownloadMock.mockImplementation(async (request: UpdateDownloadRequest) => ({
      ...
      data: {
        ...
        file_path: '/tmp/BiWork-2.1.14-mac-arm64.dmg',
      },
    }));
  });
  ...
  it('restores a cached completed auto-update on mount', async () => {
    mocks.autoUpdateRestoreDownloadedMock.mockResolvedValue({
      ...
      data: {
        ready: true,
        version: '2.1.14',
        filePath: '/cache/pending/BiWork-2.1.14-mac.zip',
      },
    });
  ...
  it('shows consumed silent installer failure marker with retry, log, and feedback actions', async () => {
    const marker: InstallerLastFailureMarker = {
      ...
      retryCount: 3,
      instDir: 'D:\\BiWork',
      logPath: 'C:\\Users\\me\\AppData\\Local\\Temp\\biwork-installer-2.1.27-20260702-151830-ab12cd34ef56.log',
