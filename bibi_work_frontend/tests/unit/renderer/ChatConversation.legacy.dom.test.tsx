...
function legacyConversation(type: 'gemini' | 'codex' | 'openclaw-gateway' | 'nanobot' | 'remote'): TChatConversation {
  return {
    ...
    type,
    model: {},
    extra: { workspace: '/tmp/biwork-history' },
    status: 'finished',
    source: 'biwork',
    created_at: 1,
    modified_at: 1,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/biwork-history', backend: 'claude' },
            status: 'finished',
            source: 'biwork',
            created_at: 1,
            modified_at: 1,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/biwork-history', backend: 'claude', current_model_id: 'model-1' },
            status: 'finished',
            source: 'biwork',
            created_at: 1,
            modified_at: 1,
