...
describe('AssistantSelectionArea', () => {
  it('keeps the assistant picker visible after an assistant is selected', () => {
    ...
    expect(screen.getByTestId('preset-pill-bare-codex')).toBeInTheDocument();
  ...
  it('moves overflow assistants into a more dropdown', async () => {
    ...
    // (builtin). So the top row is [bare-codex, user-research, user-review,
    ...
    expect(screen.queryByTestId('assistant-overflow-bare-codex')).not.toBeInTheDocument();
