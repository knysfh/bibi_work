...
describe('transformMessage', () => {
  ...
  it('preserves structured metadata on live tips error messages', () => {
    const message: IResponseMessage = {
      type: 'tips',
      data: {
        content: 'BiWork failed while sending the message',
        type: 'error',
        source: 'send_failed',
        code: 'INTERNAL_ERROR',
        error: {
          message: 'BiWork failed while sending the message',
          code: 'BIWORK_INTERNAL_ERROR',
          ownership: 'biwork',
  ...
  it('preserves trace diagnostics on live stream error messages', () => {
    const message: IResponseMessage = {
      type: 'error',
      data: {
